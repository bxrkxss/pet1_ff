      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            borderColor: const Color(0x00EF3939),
            borderRadius: 20.0,
            borderWidth: 1.0,
            buttonSize: 40.0,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: PinCodeTextField(
                        ...
                        errorTextSpace: 16.0,
                        showCursor: true,
                        cursorColor: FlutterFlowTheme.of(context).primary1,
                        obscureText: false,
                        hintCharacter: '●',
                        ...
                        pinTheme: PinTheme(
                          ...
                          selectedColor: FlutterFlowTheme.of(context).grey,
                          activeFillColor:
                              FlutterFlowTheme.of(context).primary1,
                          inactiveFillColor:
                              FlutterFlowTheme.of(context).alternate,
                          selectedFillColor: FlutterFlowTheme.of(context).grey,
                        ),
